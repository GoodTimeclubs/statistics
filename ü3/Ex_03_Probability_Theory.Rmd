...
x <- runif(N) #random
int_hat = mean(x) #Durchschnittshöhe und Breite ist 1

c_hat_i = 1/int_hat
c_hat_i

#einzeiler für Fläche
#intigrate(function(x)x, 0,1)
...
```         
#Normalverteilung
#rnorm(n,MEAN,Standard Abweichung)
#dnorm für genau ein x
#pnorm für WK <= x

Xn = nrorm (N, mean = 0, sd = 1)
...
#Untere grenze L und obere grenze R
N = 1000000
